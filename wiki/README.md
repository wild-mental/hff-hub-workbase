---
title: 위키 README — Super-Calc 지식 베이스
type: meta
status: stable
...
# Super-Calc 지식 베이스 (LLM-Wiki)

본 디렉터리는 **국내 건강기능식품 성분·가격 비교 플랫폼(코드명 Super-Calc)** MVP 기획·개발을 위한 누적형 지식 베이스다. `raw/` 폴더의 13개 비즈니스/제품 문서를 LLM이 읽고, 요약·재구성·교차 참조해 만들어낸 위키다.
...
- **핵심 기능 4종:** F1 Super-Calc Engine · F2 Anti-BS Dashboard · F3 Viral Engine · F4 Data Trust System.
...
| 활동 기록 | [`log.md`](log.md) |
| 제품 자체 | [`entities/product-super-calc.md`](entities/product-super-calc.md) |
